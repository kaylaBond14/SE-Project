...
// 1️⃣ Manage Movies
// 1️⃣ Manage Movies (Dashboard-like layout)
const AdminMoviesPage = ({ onBack, onNavigate }) => {
  const [currentMode, setCurrentMode] = useState('menu'); // 'menu' or 'add'

  // Styles — same as AdminDashboard
  const containerStyle = {
    display: 'flex',
    justifyContent: 'center',
    flexWrap: 'wrap',
      ...
      <div style={{ padding: '2rem', textAlign: 'center' }}>
        ...
        <div style={containerStyle}>
          ...
          <div
            ...
            onMouseOut={e => e.currentTarget.style.transform = 'scale(1)'}
          >
            <h2 style={cardTitleStyle}>Add Movie</h2>
            <p style={cardDescStyle}>Create a new movie with all required details.</p>
          </div>

          {/* Edit Movie */}
          <div
            style={cardStyle}
            onClick={() => alert("Edit Movie feature coming soon!")}
            onMouseOver={e => e.currentTarget.style.transform = 'scale(1.03)'}
            onMouseOut={e => e.currentTarget.style.transform = 'scale(1)'}
          >
            <h2 style={cardTitleStyle}>Edit Movie</h2>
            <p style={cardDescStyle}>Modify details of existing movies. (Coming soon)</p>
          </div>
          ...
          <div
            ...
            onMouseOut={e => e.currentTarget.style.transform = 'scale(1)'}
          >
            <h2 style={cardTitleStyle}>Delete Movie</h2>
            <p style={cardDescStyle}>Remove a movie from listings. (Coming soon)</p>
          </div>
        </div>
      </div>
    );
