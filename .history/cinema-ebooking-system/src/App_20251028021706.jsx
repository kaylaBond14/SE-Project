...
const handleFakeLogin = () => {
  ...
  return (
    <Login
      onLoginSuccess={(role) => {
        setIsLoggedIn(true);
        setCurrentUser({ role }); //  store the role in user state

        if (role === 'admin') {
          setCurrentPage('admin-dashboard'); //  admin goes here
        } else {
          setCurrentPage('home'); //  user goes to new homepage with dashboard
        }
      }}
